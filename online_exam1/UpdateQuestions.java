...
public class UpdateQuestions extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnUpdate.setFont(new java.awt.Font("Segoe UI Black", 1, 24)); // NOI18N
                             ...
                             String opt2=txtOption2.getText();
                                    String opt3=txtOption3.getText();
                                           String opt4=txtOption4.getText();
                                                  ...
                                                  try{
                                                   Connection con= SQL_CONNECTION.getcon();
                                                   PreparedStatement ps=con.prepareStatement("update questions set Question=?,Option1=?,Option2=?,Option3=?,Option4=?,Answer=? where Id=?");
                                                                                 ...
                                                                                 ps.setString(6,ans);
                                                                                       ps.setString(7,id);
                                                                                           ...
                                                                                           ps.executeUpdate();
                                                                                              JFrame jf=new JFrame();
                                                                                                                jf.setAlwaysOnTop(true);
                                                                                                                       JOptionPane.showMessageDialog(jf,"DataBase was updated successfully with no issues" );
                                                                                                                       setVisible(false);
