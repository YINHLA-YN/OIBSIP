...
public class Rules extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("2. if number is guessed correctly you will have 100 points");

        jLabel5.setFont(new java.awt.Font("Franklin Gothic Medium Cond", 0, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 102, 102));
        jLabel5.setText("3. If you guessed incorrectly 20 points will be deducted from your current score");

        jLabel6.setFont(new java.awt.Font("Franklin Gothic Medium Cond", 0, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 102, 102));
        jLabel6.setText("4. You will have to guess numbers between 1 to 100");

        jLabel7.setFont(new java.awt.Font("Artifakt Element Heavy", 1, 18)); // NOI18N
    ...
    new Game_Page(Name).setVisible(true);
    this.dispose();
